...
export const news: News[] = [
  ...
  { id: 'n6', title: 'Chọn sơn nội thất: bóng, mờ hay bán bóng?', date: '05/08/2026', tag: 'Kiến thức', excerpt: 'Mỗi loại sơn phù hợp với một không gian khác nhau. Cùng Sửa chữa nhà 365 chọn đúng để tường bền đẹp nhiều năm.', image: nimg('photo-1562259949-e8e7689d7828'), author: 'KTV Trần Minh Tuấn', readMin: 3, body: ['Chọn độ bóng của sơn không chỉ là chuyện thẩm mỹ mà còn ảnh hưởng đến độ bền và khả năng lau chùi của bề mặt tường.', 'Sơn mờ (matt): che khuyết điểm tường tốt nhất, phù hợp phòng ngủ, phòng khách trần cao. Nhược điểm là khó lau chùi vết bẩn.', 'Sơn bán bóng (satin / semi-gloss): cân bằng giữa thẩm mỹ và độ bền, dễ lau chùi. Lựa chọn phổ biến cho phòng khách, hành lang, phòng trẻ em.', 'Sơn bóng (gloss): chống bám bẩn và ẩm tốt nhất, thích hợp bếp, nhà vệ sinh, cửa gỗ. Tuy nhiên lộ rõ mọi khuyết điểm nên đòi hỏi bề mặt phải được bả thật phẳng.', 'Sửa chữa nhà 365 thi công sơn 1 lót 2 phủ với Dulux, Jotun, Mykolor, bảo hành 12 tháng. Đặt lịch khảo sát miễn phí ngay trên app.'] },
];
...
export const user = { name: 'Nguyễn Văn An', phone: '0968409323', points: 2404, tier: 'Vàng', nextTier: 'Kim Cương', nextTierAt: 5000, address: '88 Đường Số 18, Hiệp Bình, Hồ Chí Minh' };
...
export const promos: Promo[] = [
  { id: 'p1', headline: 'GIẢM', amount: '100K', sub: 'KHI DÙNG COMBO 2 TRONG 3 DỊCH VỤ ĐIỆN LẠNH', items: ['VỆ SINH MÁY LẠNH', 'VỆ SINH MÁY GIẶT', 'VỆ SINH TỦ LẠNH'], foot: '* Đặt lịch trên app Sửa chữa nhà 365 giảm ngay 30k - 50k điện lạnh và 50k cho các dịch vụ xây dựng, cơ khí, điện nước, gỗ.', colors: ['#FFF8DC', '#FFE066'] },
